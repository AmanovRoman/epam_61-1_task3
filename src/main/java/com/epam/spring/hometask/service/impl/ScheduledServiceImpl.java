...
public class ScheduledServiceImpl implements ScheduledService {
    ...
    @Override
    public int setNewEventSchedule(ScheduledEvents scheduledEvents, UserType userType)
            throws IllegalArgumentException {
        if (userType != UserType.ADMIN)
            throw new IllegalArgumentException("User type must be ADMIN");
        return scheduleEventDao.save(scheduledEvents);

    }

    @Override
    public int setNewEventSchedule(int eventId, int auditoriumId, String eventTime, double ticketPriceMultiplier, int userId)
    ...
    @Override
    public int setNewEventSchedule(Event event, Auditorium auditorium, LocalDateTime eventTime, double ticketPriceMultiplier, UserType userType)
            throws NullPointerException {
