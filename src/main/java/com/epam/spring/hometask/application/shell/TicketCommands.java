...
public class TicketCommands {
    ...
    public static String showTickets() {
        ...
        TicketServiceDao ticketService = (TicketServiceDao) ContextReceiver.getContext().getBean("ticketService");
...
//        System.out.println(seatList);
        TicketServiceDao ticketService = (TicketServiceDao) ContextReceiver.getContext().getBean("ticketService");
        AuditoriumServiceDao audService = (AuditoriumServiceDao) ContextReceiver.getContext().getBean("auditoriumService");
